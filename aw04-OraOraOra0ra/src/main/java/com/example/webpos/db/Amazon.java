...
public class Amazon implements PosDB {
    ...
    public static List<Product> parseAmazon(String keyword, int limit) throws IOException {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/" + keyword, "root", "jsxyswg");
        ...
        try {
            ...
            if (!stmt.execute(String.format("SELECT * FROM " + keyword + ".%s LIMIT %d, %d;", keyword, 0, limit))) {
                return list;
            }
